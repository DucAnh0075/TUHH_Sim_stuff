        ...
        <div className="mx-auto w-full max-w-4xl px-8 py-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-gray-200 pt-6">
            <button
              ...
              className="cursor-pointer rounded-lg border-2 border-gray-300 px-6 py-2.5 font-semibold text-gray-700 transition-colors hover:border-gray-500 hover:text-gray-900 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Zurück
            </button>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className={
                  evaluated
                    ...
                    : 'cursor-pointer rounded-lg bg-gray-900 px-6 py-2.5 font-semibold text-white transition-colors hover:bg-gray-700 disabled:cursor-not-allowed disabled:opacity-40'
                }
              >
              ...
              <button
                ...
                className={
                  evaluated
                    ? 'cursor-pointer rounded-lg bg-gray-900 px-6 py-2.5 font-semibold text-white transition-colors hover:bg-gray-700'
                    : 'cursor-pointer rounded-lg border-2 border-gray-300 px-6 py-2.5 font-semibold text-gray-700 transition-colors hover:border-gray-500 hover:text-gray-900'
                }
              >
